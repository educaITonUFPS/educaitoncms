        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px; border-bottom: 3px solid #aa1916; padding: 0;">
          <h1 class="pull-left" style="font-size:36px;">Galer&iacute;as de im&aacute;genes</h1>
            ...
            <div class="gdl-custom-sidebar" id="galerias" style='z-index:9;'>
              <a onclick="filtreEvento(event, 'galerias', '0')" class="ufps-btn<?php if ($_activo == 0) { echo " ufps-btn-light-active"; } else { echo " ufps-btn-light"; } ?>">Todas</a>
<?php
            ...
            <div class="items-row cols-<?php echo $_enlaces[$_a][0]; ?> row-0">
              <div class="item-information column-1">
                ...
                <div class="img-intro-right-nopointer20 img-intro-right">
                  <?php if ($_silink) { echo "<a href=\"./index.php?modulo=detallegaleria&idtipog=".$_activo."&idgale=".$_enlaces[$_a][0]."\">"; } ?><img class="imgInformacion" src="<?php echo $_enlaces[$_a][2]; ?>" alt=""/><?php if ($_silink) { echo "</a>"; } ?>
                </div>
                <?php } ?>
                <div class="float_content">
                  <h1 class="tituloinformacion">
                    <?php if ($_silink) { echo "<a class=\"tituloGaleria\" href=\"./index.php?modulo=detallegaleria&idtipog=".$_activo."&idgale=".$_enlaces[$_a][0]."\">"; } ?>
                    <?php echo utf8_encode($_enlaces[$_a][3]); ?><?php if ($_silink) { echo "</a>"; } ?>
                  </h1>
<?php echo utf8_encode($_enlaces[$_a][4]); ?>
                </div>
              <?php if ($_a < (count($_enlaces)-1)) { echo "<span class=\"row-separator\"></span>"; } ?>
              </div>
            </div>
<?php
      }
...
?>
            ...
            <p class="readmore-center readmore">
              <a href="./index.php?modulo=galerias<?php /**/ if(isset($_GET['idtipog'])) { echo "&idtipog=".$_GET['idtipog']; } if (isset($_GET['pagina'])) { echo "&pagina=\"".$_GET['pagina']; } ?>">
