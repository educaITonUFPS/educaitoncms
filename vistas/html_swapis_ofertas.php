...
?>
    ...
    <div class="ufps-modal-header ufps-modal-header-red">
    <span class="ufps-modal-close">&times;</span>
        <h2 id="tituloaddbox" style="color:#fff;"><?php if ($_idedicion) { echo "Editar oferta Id. ".$_idedicion; } else { echo "Agregar una nueva oferta"; } ?></h2>
    </div>
...
?>
          ...
          <p class="pnormal">Fecha final: <input type="text" class="ufps-input-short ufps-input" name="fechfin" id="fechfin"<?php if ($_idedicion) { echo " value=\"".$_campos[2]."\""; } ?>> <span style="font-style:italic">(Use la misma fecha inicial para una oferta de duraci&oacute;n indefinida)</span></p>
          <p class="pnormal">Cargo:<br><textarea class="ufps-textarea" name="cargo"><?php if ($_idedicion) { echo utf8_encode($_campos[3]); } ?></textarea></p>
          <p class="pnormal">Descripci&oacute;n:<br><textarea class="ufps-textarea" id="descripto" name="descripto"><?php if ($_idedicion) { echo utf8_encode($_campos[4]); } ?></textarea></p>
          <p class="pnormal" style="margin-top:15px;">Habilidades:<br><textarea class="ufps-textarea" id="habilidades" name="habilidades"><?php if ($_idedicion) { echo utf8_encode($_campos[5]); } ?></textarea></p>
