        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px; border-bottom: 3px solid #aa1916; padding: 0;">
          <h1 class="pull-left" style="font-size:36px;">Novedades</h1>
            ...
            <div class="gdl-custom-sidebar" id="eventos" style="z-index:9;">
              <a onclick="filtreEvento(event, 'eventos', '0')" class="ufps-btn<?php if ($_activo == 0) { echo " ufps-btn-light-active"; } else { echo " ufps-btn-light"; } ?>">Todas</a>
<?php
              ...
              <div class="item-information column-1">
                ...
                <div class="float_content">
                  <h1 class="tituloinformacion">
                    <?php if ($_silink) { echo "<a class=\"anchorinformacion\" href=\"./index.php?modulo=verinformacion&idtipoi=".$_activo."&idinfo=".$_enlaces[$_a][0]."\">"; } ?>
...
?>
              <div style="clear:both"></div>
              <p class="readmore">
                <a href="<?php if ($_silink) { echo "./index.php?modulo=verinformacion&idtipoi=".$_activo."&idinfo=".$_enlaces[$_a][0]; } else { echo "javascript:;"; } ?>">
                  Leer más...</a>
              </p>
              <div style="clear:both"></div>
<?php
...
<?php echo utf8_encode($_enlaces[0][6]); ?>
            ...
            <p class="readmore-center readmore">
              <a href="./index.php?modulo=principal<?php /**/ if(isset($_GET['idtipoi'])) { echo "&idtipoi=".$_GET['idtipoi']; } if (isset($_GET['pagina'])) { echo "&pagina=\"".$_GET['pagina']; } ?>">
