...
?>
          ...
          <td class="ufps-text-center"><?php echo "<input name=\"activo".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['activo'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"visible".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['visible'] == 1) { echo " checked"; } echo ">"; ?></td>
...
?>
          ...
          <td class="ufps-text-center"><?php echo "<input name=\"activo".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['activo'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"visible".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['visible'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"transversal".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['transversal'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"orden".$_a."\" type=\"text\" class=\"ufps-input-number ufps-input-short ufps-input\" value=\"".utf8_encode($_registros[$_a]['orden'])."\""; ?>></td>
<?php
            break;
          }
...
?>
          <td class="ufps-text-center"><?php echo $_registros[$_a]['id']; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"descripcion".$_a."\" type=\"text\" class=\"ufps-input-short ufps-input\" value=\"".utf8_encode($_registros[$_a]['descripcion'])."\""; ?>></td>
          <td class="ufps-text-center"><?php echo "<input name=\"esnoticia".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['esnoticia'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"activo".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['activo'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"orden".$_a."\" type=\"text\" class=\"ufps-input-number ufps-input-short ufps-input\" value=\"".utf8_encode($_registros[$_a]['orden'])."\""; ?>></td>
<?php
            break;
...
?>
          <td class="ufps-text-center"><?php echo $_registros[$_a]['id']; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"descripcion".$_a."\" type=\"text\" class=\"ufps-input-short ufps-input\" value=\"".utf8_encode($_registros[$_a]['descripcion'])."\""; ?>></td>
          <td class="ufps-text-center"><?php echo "<input name=\"puedeagregar".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['puedeagregar'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"puedeautorizar".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['puedeautorizar'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"puedecambiar".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['puedecambiar'] == 1) { echo " checked"; } echo ">"; ?></td>
          <td class="ufps-text-center"><?php echo "<input name=\"puedeborrar".$_a."\" type=\"checkbox\""; if ($_registros[$_a]['puedeborrar'] == 1) { echo " checked"; } echo ">"; ?></td>
<?php
            break;
          }
          case 'tipofestivos': {
