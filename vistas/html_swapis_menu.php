...
<!--
      <div style="text-align:center;">
-->
        <h2 id="tituloaddbox" style="color:#fff;"><?php if ($_idedicion) { echo "Editar elemento de men&uacute; Id. ".$_idedicion; } else { echo "Agregar nuevo elemento de men&uacute;"; } ?></h2>
<!--
      </div>
-->
    </div>
...
?>
          <p class="pnormal">T&iacute;tulo: <input type="text" class="ufps-input-medium ufps-input" name="titulo"<?php if ($_idedicion) { echo " value=\"".utf8_encode($_campos[2])."\""; } ?>></p>
          <p class="pnormal">URL: <input type="text" class="ufps-input-short ufps-input" name="url" style="width:40%;" onblur="checkurl(document.forms['annadir'].url.value);"<?php if ($_idedicion) { if ($_campos[3] != "javascript:;") { if (!is_numeric($_campos[3])) { echo " value=\"".$_campos[3]."\""; } } } ?>> <span id="urlresult" style="margin-right:10px;"><img id="urlstatus" src="<?php if ($_idedicion) { echo urlImage($_campos[3], $_idedicion); } else { echo "rsc/img/gray.png"; } ?>"></span> <input type="checkbox" name="afuera"<?php if ($_idedicion) { if ($_campos[4] == 1) { echo " checked"; } } ?>> URL abre en nueva pesta&ntilde;a</p>
<?php
...
?>
          <p class="pnormal" style="margin-top:15px;">Submen&uacute;s desplegar&aacute;n hacia la izquierda: <select name="alaizquierda"><option value="1"<?php if ($_idedicion) { if ($_campos[1] == 1) { echo " selected"; } } ?>>S&iacute;</option><option value="0"<?php if ($_idedicion) { if ($_campos[1] == 0) { echo " selected"; } } ?>>No</option></select></p>
